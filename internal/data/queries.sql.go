...
const deleteEpisodesForFeed = `-- name: DeleteEpisodesForFeed :exec
DELETE FROM Episodes WHERE feed_id = ?
`

func (q *Queries) DeleteEpisodesForFeed(ctx context.Context, feedID string) error {
	_, err := q.db.ExecContext(ctx, deleteEpisodesForFeed, feedID)
	return err
}
...
func (q *Queries) DeleteFeed(ctx context.Context, id []byte) error {
...
func (q *Queries) GetFeed(ctx context.Context, id []byte) (Feed, error) {
